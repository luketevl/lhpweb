...
$this->sections[] = array(
    ...
    'fields'    => array(
        ...
        array(
            'id'        => 'breadcrumbs',
            'type'      => 'button_set',
            'title'     => __('Show Breadcrumbs?', THEME_TEAM),
            'subtitle'  => __('Show Breadcrumbs on top of the pages?', THEME_TEAM),
            'options'   => array(
                1       => '&nbsp;I&nbsp;',
                0       => 'O',
            ),
        ...
        array(
            ...
            'subtitle'  => __('Enables comments for static pages.', THEME_TEAM),
            'options'   => array(
                1       => '&nbsp;I&nbsp;',
                0       => 'O',
            ),
