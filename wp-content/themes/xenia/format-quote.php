<?php
    ...
    $quote_text = rwmb_meta( THEME_SLUG . "_postformat_quote_text" );
    $quote_author = rwmb_meta( THEME_SLUG . "_postformat_quote_author" );
?>
...
<div class="cl-blog-naz">
    <div class="cl-blog-type"><i class="icon-comment"></i></div>
    ...
    <div class="cl-blog-name">
        ...
        <?php if ($quote_text) : ?>
            ...
            <?php if ($quote_author) : ?>
                <div class="post-format-quote-author">&mdash; <?php echo $quote_author; ?></div>
            <?php endif; ?>
        <?php else : ?>
            <a href="<?php echo $permalink; ?>"><?php the_title(); ?></a>
        <?php endif; ?>
